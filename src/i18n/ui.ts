...
const en = {
  ...
  'blog.title': 'Blog — all posts by tag · Hai Truong',
  'blog.description':
    'Every post on the blog, filterable by tag — fullstack JavaScript, side projects, lessons learned.',
  'blog.badge': "Everything I've written",
...
const vi: Record<keyof typeof en, string> = {
  ...
  'home.tags.all': 'Tất cả',
  'home.viewAll': 'Xem tất cả bài viết',
  'blog.title': 'Tất cả bài viết theo tag · Blog của Hai Truong',
  'blog.description':
    'Tất cả bài viết trên blog, lọc được theo tag — fullstack JavaScript, side project, bài học rút ra.',
  'blog.badge': 'Tất cả những gì mình đã viết',
  'blog.heading': 'Tất cả bài viết',
